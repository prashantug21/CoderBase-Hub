        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-8">
            {!isOwnProfile && !alreadyFriend && (
                <div className="flex justify-end mb-4">
                    <button
                        onClick={() => addFriend({ friendId: username })}
                    >
            ...
            <div className="w-full grid lg:flex lg:justify-between grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 my-8 justify-items-center">
                <Card className={`w-full md:max-w-sm  shadow-[8px_8px_0px_0px_rgba(0,0,0)] rounded-2xl border-2 border-black p-4 flex items-center gap-4`}><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="leetcode" width={24} height={24} className="w-8 h-8">
                ...
                </svg></span><a href={`https://www.leetcode.com/${query.data[4].leetcode}`} target="blank">{query.data[4].leetcode}</a></Card>
                <Card className={`w-full md:max-w-sm  shadow-[8px_8px_0px_0px_rgba(0,0,0)] rounded-2xl border-2 border-black p-4 flex items-center gap-4`}><span><svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" id="code-forces" width={24} height={24} className="w-8 h-8">
                ...
                </svg></span><a href={`https://codeforces.com/profile/${query.data[4].codeforces}`} target="blank">{query.data[4].codeforces}</a></Card>
                <Card className={`w-full md:max-w-sm  shadow-[8px_8px_0px_0px_rgba(0,0,0)] rounded-2xl border-2 border-black p-4 flex items-center gap-4`}><span>
                    <svg xmlns="http://www.w3.org/2000/svg" id="GFG" width={24} height={24} className="w-8 h-8" viewBox="0 0 59.077 29.539">
                    ...
                    </svg></span><a href={`https://www.geeksforgeeks.org/user/${query.data[4].gfg}`} target="blank">{query.data[4].gfg}</a></Card>
                <Card className={`w-full md:max-w-sm  shadow-[8px_8px_0px_0px_rgba(0,0,0)] rounded-2xl border-2 border-black p-4 flex items-center gap-4`}><span>
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={24} height={24} className="w-8 h-8" viewBox="0 0 50 50">
                    ...
                    </svg></span><a href={`https://www.codechef.com/users/${query.data[4].codechef}`} target="blank">{query.data[4].codechef}</a></Card>
